    ...
    <ul class="navbar-nav navbar-sidenav" id="exampleAccordion">
      <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Dashboard">
        <a class="nav-link" id="btn1">
          ...
          <span class="nav-link-text">企业主页</span>
        </a>
      </li>
      <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Charts">
        <a class="nav-link" id="stu">
          <i class="fa fa-fw fa-area-chart"></i>
          <span class="nav-link-text">应聘学生列表</span>
        </a>
      </li>
      <li class="nav-item" data-toggle="tooltip" data-placement="right" title="Tables">
        <a class="nav-link" id="judge">
...
<div class="content-wrapper">
  ...
  <div class="card mb-3" id="box1">
    <div class="card-header">
      <i class="fa fa-table"></i>企业信息</div>
      <div class="card-body">
      <div class="col-12">
        <h3>公司编号</h3>
        <p>${user.companyid}</p>
        ...
        <h3>招人状态</h3>
        <c:choose>
          <c:when test="${user.recruit eq 'no'}">
            <p>没有招人</p>
          </c:when>
          <c:otherwise>
            <p>正在招人</p>
        ...
        <button class="btn btn-primary btn-block"  onclick="changerecruit('${user.companyid}')"  style="width: 10%">改变招聘状态</button>
      </div>
    </div>
  </div>
...
<script>
    function f1(stuid){
        window.open("/downjianli?stuid="+stuid)
        $.ajax({
